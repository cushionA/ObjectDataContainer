...
namespace ToolCodeGenerator.Tests
{
    ...
    public class DataContainerPerformanceTests
    {
        ...
        /// <summary>
        /// 従来方式でのエンティティ追加のパフォーマンスを測定
        /// Dictionary×3 + List×3への同時追加処理の速度を計測
        /// </summary>
        [Test, Performance]
        ...
        /// 単一TryGetValueで全データを一括取得し、戦闘力を計算する速度を計測
        /// </summary>
        [Test, Performance]
